    ...
    jsMind.draggable.prototype = {
        ...
        dragstart: function (e) {
            ...
            if (!!nodeid) {
                ...
                if (!node.isroot) {
                    ...
                    var zoom = this.jm.view.actualZoom; // FIX: Add this line
                    this.offset_x = (e.clientX || e.touches[0].clientX)/zoom - el.offsetLeft; // FIX: Divide by zoom
                    this.offset_y = (e.clientY || e.touches[0].clientY)/zoom - el.offsetTop; // FIX: Divide by zoom
        ...
        drag: function (e) {
            ...
            if (this.capture) {
                ...
                clear_selection();
                var zoom = this.jm.view.actualZoom; // FIX: Add this line
                var px = (e.clientX || e.touches[0].clientX)/zoom - this.offset_x; // FIX: Divide by zoom
                var py = (e.clientY || e.touches[0].clientY)/zoom - this.offset_y; // FIX: Divide by zoom
        
                //var cx = px + this.client_hw; // FIX: This line doesn't do anything
                //var cy = py + this.client_hh; // FIX: This line doesn't do anything
